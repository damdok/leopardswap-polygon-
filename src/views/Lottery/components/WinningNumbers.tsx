      ...
      <Card>
        <CardBody>
          <StyledCardContentInner>
            <StyledCardHeader>
              <Title style={{color:colors.textSubtle,fontSize: "18px"}}>
            ...
            <Row>
              {winNumbers.map((number, index) => (
                ...
                <TicketNumberBox key={index} style={{border: "2px dashed ".concat(colors.textSubtle)}}>
            ...
            <Link href="https://bscscan.com/" target="_blank" style={{color:colors.textSubtle,fontSize:"16px",textAlign:"center" }}>

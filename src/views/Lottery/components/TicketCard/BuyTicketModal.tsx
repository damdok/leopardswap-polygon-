  ...
  return (
    <Modal title={TranslateString(450, 'Enter amount of tickets to buy')} onDismiss={onDismiss}>
      <TicketInput
        ...
        max={fullBalance}
        symbol="TICKET"
        availableSymbol="LEOPARD"
      />
      <div>
        <Tips>Your amount must be a multiple of 10 LEOPARD</Tips>
        <Tips>1 Ticket = 10 LEOPARD</Tips>
      </div>
      <div>
        <Announce>         
          Ticket purchases are final. Your LEOPARD cannot be returned to you after buying tickets.         
        </Announce>
        <Final>{TranslateString(460, `You will spend: ${cakeCosts(val)} LEOPARD`)}</Final>
      </div>
      <ModalActions>
